...
class DiegoSouza_CheckoutSimplificado_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    {
        if (!Mage::getStoreConfig('checkoutsimplificado/general/newsletter_checkbox'))
            return false;
