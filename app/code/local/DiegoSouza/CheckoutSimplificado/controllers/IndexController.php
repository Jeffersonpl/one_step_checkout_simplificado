<?php
class DiegoSouza_CheckoutSimplificado_IndexController extends Mage_Checkout_Controller_Action
{
    ...
    {$this->_initLayoutMessages('checkout/session');
        if ($this->_current_layout === null)
        {
            ...
            $update->load('checkoutsimplificado_index_updatecheckout');
...
///////////////
    ...
    public function saveOrderAction()
    {
        ...
        try {
            ...
            $agreements = Mage::helper('checkoutsimplificado')->getAgreeIds();
            if($agreements)
            {
